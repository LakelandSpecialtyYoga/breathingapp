...
const breaths = document.querySelector(".breaths");
let breathsLeft = 3;
...
const breathTextUpdate = () => {
  if (breathsLeft === "infinte"){
    breathsText.innerText = "Just Breathe";
    breaths.innerText = "";
...
const breathingApp = () => {
  const breathingAnimtaion = setInterval(() => {
    if (breathsLeft === 0) {
      ...
      instructions.innerText = "Breathing session completed. Namaste";
